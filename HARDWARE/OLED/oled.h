...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_8)			//CLK	PA6 SCK D0
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_8)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_9)			//DIN	PA7 MISO D1
#define OLED_SDIN_Set() GPIO_SetBits(GPIOB,GPIO_Pin_9)


//#define OLED_RST_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_4)				//RES	PC4
//#define OLED_RST_Set() GPIO_SetBits(GPIOC,GPIO_Pin_4)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_12)				//DC	PB6
#define OLED_DC_Set() GPIO_SetBits(GPIOB,GPIO_Pin_12)

#define OLED_CS_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_13)				//CS  	PB7
